...
IMPORTANT NOTE ON THIS BRANCH: IF YOU WANT TO COMPILE THIS BRANCH WITH MTSIMPORT THEN COMPILATION WILL FAIL BECAUSE OF SOME COMPILATION ERRORS WITH THE COLLADA LIBRARY. CURRENTLY I DO NOT HAVE A FIX FOR THOSE ERRORS. FOR NOW USE develop_working-mtsimport-and-python branch.
