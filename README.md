...
CURRENTLY THIS BRANCH COMPILES CORRECTLY, BUT MTSGUI AND MTSIMPORT DO NOT WORK. IF YOU NEED THESE PLUGINS USE: develope_working-mtsimport-and-python branch
